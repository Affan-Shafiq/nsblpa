        ...
        child: Column(
          ...
          children: [
            ...
            if (_isEditing) ...[
              ...
              _buildInfoRow('Active Contracts', player.contracts.where((c) => c.isActive).length.toString()),
              _buildInfoRow('Active Endorsements', player.endorsements.where((e) => e.isActive).length.toString()),
            ],
          ],
        ),
      ),
